...
local positionArray = {
	...
	{x = 10, y = 65, width = 200 * configArray.textSize.value, height = ((functions.getTableCount(configArray) + 4) * lineMultiplier) + 10}, -- options
...
local function drawOptions(inputX, inputY)
	...
	tableInsert(optionsArray, bridge.addText(inputX + (150 * configArray.textSize.value), inputY, tostring(configArray.textSize.value), configArray.textColor.value).setScale(size.small))
	...
	tableInsert(optionsArray, bridge.addText(inputX + (150 * configArray.textSize.value), inputY, functions.decToHex(configArray.textColor.value), configArray.textColor.value).setScale(size.small))
	...
	tableInsert(optionsArray, bridge.addText(inputX + (150 * configArray.textSize.value), inputY, tostring(configArray.opacity.value), configArray.textColor.value).setScale(size.small))
...
local function updateSize(newSize)
	...
	positionArray = {
		...
		{x = 10, y = 65, width = 200 * newSize, height = ((functions.getTableCount(configArray) + 4) * lineMultiplier) + 10}, -- options
